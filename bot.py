...
/skills - используй для выбирания навыка
/projects - используй дял того что бы посмотреть свои прооекты
/delete - используй для удаления своего проекта
/update_projects - используй для изменнения своего проекта
